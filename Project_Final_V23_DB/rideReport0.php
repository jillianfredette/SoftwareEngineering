...
<body>
    ...
    <div id="container" style="width: 1000px; height: 600px; margin: 0 auto;">
        ...
        for ($x = 1; $x <= 12; $x++)
        {
          $nRows = $pdo->query("SELECT COUNT(*) FROM THEMEPARK.RIDES_ON WHERE Ride_date between '2017-$x-01 00:00:00' and '2017-$x-31 23:59:00'")->fetchColumn();
                    array_push($amount0, (int)$nRows);
        }
        for ($x = 1; $x <= 12; $x++)
        {
          $nRows = $pdo->query("SELECT COUNT(*) FROM THEMEPARK.RIDES_ON WHERE Ride_date between '2018-$x-01 00:00:00' and '2018-$x-31 23:59:00'")->fetchColumn();
          array_push($amount1, (int)$nRows);
        }
        for ($x = 1; $x <= 12; $x++)
        {
          $nRows = $pdo->query("SELECT COUNT(*) FROM THEMEPARK.RIDES_ON WHERE Ride_date between '2019-$x-01 00:00:00' and '2019-$x-31 23:59:00'")->fetchColumn();
    ...
    <script type="text/javascript">
        var yr0 = <?php echo json_encode($amount0); ?>;
        var yr0sum = <?php echo json_encode($sum0); ?>;
        var yr1 = <?php echo json_encode($amount1); ?>;
        var yr1sum = <?php echo json_encode($sum1); ?>;
        var yr2 = <?php echo json_encode($amount2); ?>;
        var yr2sum = <?php echo json_encode($sum2); ?>;
    </script>
    <div class="content">
        <h2>Totals</h2>
        <div class="row">
    ...
    <div class="content">
        ...
        <p>
            Average rides per month: <script type="text/javascript">
                document.write(averageMonth(yr0));
            </script><br>
            Most ridden month: <script type="text/javascript">
                document.write(maxMonth(yr0));
            </script>.<br>The percentage increase for this month when compared to the mean is:
            <script type="text/javascript">
                document.write(percentDiffmax(yr0));
            </script>%.
            <br>
            Least ridden month: <script type="text/javascript">
                document.write(minMonth(yr0));
            </script>.<br>The percentage decrease for this month when compared to the mean is:
            <script type="text/javascript">
                document.write(percentDiffmin(yr0));
            </script>%.
        </p>
        <h3 align="left">2018</h3>
        <p>
            Average rides per month: <script type="text/javascript">
                document.write(averageMonth(yr1));
            </script><br>
            Most ridden month: <script type="text/javascript">
                document.write(maxMonth(yr1));
            </script>.<br>The percentage increase for this month when compared to the mean is:
            <script type="text/javascript">
                document.write(percentDiffmax(yr1));
            </script>%.
            <br>
            Least ridden month: <script type="text/javascript">
                document.write(minMonth(yr1));
            </script>.<br>The percentage decrease for this month when compared to the mean is:
            <script type="text/javascript">
                document.write(percentDiffmin(yr1));
            </script>%.
        </p>
        <h3 align="left">2019</h3>
        <p>
            Average rides per month: <script type="text/javascript">
                document.write(averageMonth(yr2));
            </script><br>
            Most ridden month: <script type="text/javascript">
                document.write(maxMonth(yr2));
            </script>.<br>The percentage increase for this month when compared to the mean is:
            <script type="text/javascript">
                document.write(percentDiffmax(yr2));
            </script>%.
            <br>
            Least ridden month: <script type="text/javascript">
                document.write(minMonth(yr2));
            </script>.<br>The percentage decrease for this month when compared to the mean is:
            <script type="text/javascript">
                document.write(percentDiffmin(yr2));
            </script>%.
    </div>
    <div class="content">
        <h2 align="left">Maintenance Data</h2>
        <?php
          ...
          echo "<br>";
            for($i = 2011; $i <= 2019; $i++)
            {
              $sth = $pdo->prepare("SELECT COUNT(Maintenance_ID), SUM(Maintenance_cost) FROM THEMEPARK.RIDE_MAINTENANCE WHERE Start_date_maintenance BETWEEN '$i-01-01' AND '$i-12-31';");
                $sth->execute();
                while($row = $sth->fetch(PDO::FETCH_ASSOC))
            {
              echo $i;
              echo "<br>";
              echo "Amount of maintenance jobs started in the year: ";
              echo $row['COUNT(Maintenance_ID)'];
              echo "<br>";
              echo "Maintenance cost for year: $";
              echo number_format($row['SUM(Maintenance_cost)'], 2);
              echo "<br>";
              echo "<br>";
            }
            }
    ...
    <footer class="w3-container w3-padding-32 w3-center w3-large">
        ...
        <a href="rideReport0.php"><i class='fa fa-refresh w3-hover-opacity' title="clear page" style="text-align: center; padding-right: 15px"></i></a>
